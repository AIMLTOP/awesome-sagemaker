...
export CLUSTER_SG=${EKS_CLUSTER_SG}
export ADDITIONAL_SG=${EKS_ADDITIONAL_SG}
export CUSTOMNETWORK_SG=${EKS_CUSTOMNETWORK_SG}
export SHAREDNODE_SG=${EKS_SHAREDNODE_SG}
export EXTERNAL_SG=${EKS_EXTERNAL_SG}
